...
@property (nonatomic, strong) UILabel *descLabel; //正文
...
//     必须加上这句
    self.hyb_lastViewInCell = imgView;
    self.hyb_lastViewsInCell = @[imgView];
...
- (void)configCellWithModel:(ViewModel *)model {
  ...
  if (model.isExpanded != self.isExpandedNow) {
    self.isExpandedNow = model.isExpanded;
